    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <a className="nav-link active" aria-current="page" href = "/">{props.Homenew}</a>
        </li>
        <li className="nav-item">
...
//   Homenew : PropTypes.string,
//   action : PropTypes.string,
// }

// Navbar.defaultProps = {
//   title : 'this will come if i not pass any value in a app.js navabar'
// }
